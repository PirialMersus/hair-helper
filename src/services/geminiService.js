...
Если мастер просит ПЕРЕНЕСТИ запись, генерируй ДВА действия: "cancel_appointment" для старого времени (если оно известно или на ту же дату) и "appointment" для нового.
